...
/**
 * Main component for the authentication page. This page automatically attempts auth on landing via the AuthService, then
 * redirects to the lists page on success.
 */
@Component({
  selector: 'app-auth',
